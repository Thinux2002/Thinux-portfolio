...
const ProfileBadge = () => {
  return (
    <motion.div
      ...
      className="fixed top-24 right-6 md:right-12 z-50 flex items-center gap-5 bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-2 pr-6 cursor-default group hover:border-orange-500/40 hover:bg-white/[0.06] transition-all duration-700 shadow-2xl overflow-hidden"
    >
      ...
      <div className="relative">
        <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-white/5 group-hover:border-orange-500/20 transition-all duration-700">
          <img
            src={meImg}
            alt="Thinal Dilmith"
        ...
        <div className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-black border border-white/10 flex items-center justify-center">
